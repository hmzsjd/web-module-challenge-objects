...
console.log(createMenuItem("Hot Dog", 11.99, "Lunch"));
...
function getReviewByIndex(array, idx) {
  return `${array[idx].name} gave the restaurant a ${array[idx].rating} star review, and their feedback was: ${array[idx].feedback}`;
}
